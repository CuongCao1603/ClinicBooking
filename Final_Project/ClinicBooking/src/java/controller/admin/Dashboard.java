    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("default")) {
                List<Statistic> appointment7day = appointmentdao.getDataLast7Day("14day");
                List<Statistic> reservation7day = reservationdao.getDataLast7Day("14day");
                ...
                session.setAttribute("atype", "14day");
                session.setAttribute("rtype", "14day");
