...
public class ServiceDAO {
    ...
    public List<Service> getRandomTop6Service() throws SQLException, IOException {
        ...
        String sql = "SELECT\n"
                + "    CONCAT_WS(cs.id, s.category_id) AS id,\n"
                + "    cs.name,\n"
                + "    cs.setting_id,\n"
                + "    cs.status,\n"
                + "    s.service_id,\n"
                ...
                + "    s.img\n"
                + "FROM\n"
                + "    doctris_system.service s\n"
                + "INNER JOIN\n"
                + "    doctris_system.category_service cs ON s.category_id = cs.id\n"
                + "WHERE\n"
                + "    s.status = 1\n"
                + "ORDER BY\n"
                + "    RAND()\n"
    ...
    public ArrayList<Service> getAllService() throws SQLException, IOException {
        ...
        String sql = "SELECT\n"
                ...
                + "    doctris_system.service s\n"
                + "LEFT JOIN\n"
                + "    doctris_system.ratestar r ON s.service_id = r.service_id\n"
                + "INNER JOIN\n"
                + "    doctris_system.category_service cs ON cs.id = s.category_id\n"
                + "WHERE\n"
                + "    s.status = 1\n"
                + "GROUP BY\n"
                + "    s.title,\n"
