...
//        String month = "select sum(service.fee) from reservations inner join service on reservations.service_id = service.service_id  ";
        String month = "select sum(service.fee) from reservations inner join service on reservations.service_id = service.service_id where reservations.status = 'Complete' AND month(reservations.date) = month(CURRENT_DATE)";
