<%-- 
    ...
    Created on : Jun 20, 2023, 2:25:34 AM
    Author     : DELL
--%>
...
<jsp:include page="layout/head.jsp">
    <body>
        ...
        <section class="bg-dashboard">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <h3 class="mb-0"></h3>
                            ...
                            <div class="p-4">
                                ...
                                <div class="row text-center">
                                    <div class="col-12 mt-4">
                                        <div class="d-md-flex align-content-center text-center justify-content-between">
        ...
        <a href="#" onclick="topFunction()" id="back-to-top" class="btn btn-icon btn-pills btn-primary back-to-top"><i data-feather="arrow-up" class="icon"></i></a>
